        ...
        try (
            ...
            try {
                ...
                if (choice.equals("1")) {
                    ...
                    clientOutput.println("Invalid option. Closing connection.");
                    clientSocket.close();
                }
        ...
        try {
            ...
            if (resultSet.next()) {
                ...
                do {
                    ...
                    exitRequested = !continueOption.equalsIgnoreCase("yes");
                } while (!exitRequested);
            } else {
        ...
        while (true) {
            ...
            try {
                ...
                if (resultSet.next()) {
                    ...
                    clientOutput.println("Credenciales incorrectas. Cerrando la conexión.");
                    clientSocket.close();
                    return;
                }
            } catch (SQLException e) {
